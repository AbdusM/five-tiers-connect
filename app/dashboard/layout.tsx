  ...
  return (
    <div className="min-h-screen bg-transparent flex flex-col md:flex-row">
      ...
      <div className="flex-1 flex flex-col min-h-screen md:ml-72 transition-all duration-300">
        ...
        {/* Emergency Disclaimer Footer */}
        <footer className="py-4 px-6 text-center border-t border-white/5 bg-black/20">
          <p className="text-[10px] md:text-xs text-zinc-500 font-medium">
            For immediate life-threatening emergencies, dial <span className="text-red-400 font-bold">911</span>.
            For mental health crisis, dial <span className="text-indigo-400 font-bold">988</span>.
          </p>
        </footer>
      </div>
    </div>
